...
shinyUI(fluidPage(navbarPage( "Gene Set Omic Analysis (GSOA)",
           ...
           tabPanel("Run GSOA",
                    fluidRow(
                      ...
                      column(4, wellPanel (
                        fileInput('dataFile', 'Load your omic data file.', accept = c( 'text/csv','text/comma-separated-values','text/tab-separated-values', 'text/plain', '.csv', '.tsv')),
                        fileInput('classFile', 'Load your class file.', accept = c( 'text/csv','text/comma-separated-values','text/tab-separated-values', 'text/plain', '.csv', '.tsv')),
                        fileInput('gmtFile', 'Load your .gmt file.', accept = c( 'text/csv','text/comma-separated-values','text/tab-separated-values','text/plain', '.csv', '.tsv')))),
                      ...
                      column(4, wellPanel (offset=2,
                                           numericInput('Iterations', label = 'Number of Iterations.',value=10, min = 1, max = 1000),
                                           ...
                                           numericInput("CrossValidation", "# of Cross Validations",value=1, min = 1, max = 5))),
                                          #submitButton("Submit")
